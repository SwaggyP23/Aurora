...
#include "../../../src/ImGui/ImGuiLayer.h" // Modified by SwaggyP23
#include "../../../src/Core/Application.h" // Modified by SwaggyP23
#include "../../../src/ImGui/ImGuiUtils.h" // Modified by SwaggyP23
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        if (ImGui::BeginTabItem("Sizes"))
        {
            if (ImGui::TreeNodeEx("Main", treeNodeFlags))
            {
                ...
                ImGuiUtils::PropertySliderFloat2("WindowPadding", style.WindowPadding, 0.0f, 20.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat2("FramePadding", style.FramePadding, 0.0f, 20.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat2("CellPadding", style.CellPadding, 0.0f, 20.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat2("ItemSpacing", style.ItemSpacing, 0.0f, 20.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat2("ItemInnerSpacing", style.ItemInnerSpacing, 0.0f, 20.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat2("TouchExtraPadding", style.TouchExtraPadding, 0.0f, 10.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("IndentSpacing", style.IndentSpacing, 0.0f, 30.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("ScrollbarSize", style.ScrollbarSize, 1.0f, 20.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("GrabMinSize", style.GrabMinSize, 1.0f, 20.0f, "%.0f");
            ...
            if (ImGui::TreeNodeEx("Borders", treeNodeFlags))
            {
                ...
                ImGuiUtils::PropertySliderFloat("WindowBorderSize", style.WindowBorderSize, 0.0f, 1.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("ChildBorderSize", style.ChildBorderSize, 0.0f, 1.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("PopupBorderSize", style.PopupBorderSize, 0.0f, 1.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("FrameBorderSize", style.FrameBorderSize, 0.0f, 1.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("TabBorderSize", style.TabBorderSize, 0.0f, 1.0f, "%.0f");
            ...
            if (ImGui::TreeNodeEx("Rounding", treeNodeFlags))
            {
                ...
                ImGuiUtils::PropertySliderFloat("WindowRounding", style.WindowRounding, 0.0f, 12.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("ChildRounding", style.ChildRounding, 0.0f, 12.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("FrameRounding", style.FrameRounding, 0.0f, 12.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("PopupRounding", style.PopupRounding, 0.0f, 12.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("ScrollbarRounding", style.ScrollbarRounding, 0.0f, 12.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("GrabRounding", style.GrabRounding, 0.0f, 12.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("LogSliderDeadzone", style.LogSliderDeadzone, 0.0f, 12.0f, "%.0f");
                ImGuiUtils::PropertySliderFloat("TabRounding", style.TabRounding, 0.0f, 12.0f, "%.0f");
            ...
            if (ImGui::TreeNodeEx("Alignment", treeNodeFlags))
            {
                ...
                ImGuiUtils::PropertySliderFloat2("WindowTitleAlign", style.WindowTitleAlign, 0.0f, 1.0f, "%.2f");

                int window_menu_button_position = style.WindowMenuButtonPosition + 1;
                static const char* windowMenuButtonPos[] = { "None", "Left", "Right" };
                if(ImGuiUtils::PropertyDropdown("WindowMenuButtonPosition", windowMenuButtonPos, 3, &window_menu_button_position))
                {
                    style.WindowMenuButtonPosition = window_menu_button_position - 1;
                }

                static const char* colorButtonPos[] = { "Left", "Right" };
                ImGuiUtils::PropertyDropdown("ColorButtonPosition", colorButtonPos, 2, &style.ColorButtonPosition);
                ImGuiUtils::PropertySliderFloat2("ButtonTextAlign", style.ButtonTextAlign, 0.0f, 1.0f, "%.2f", "Alignment applies when a button is larger than its text content.");
                ImGuiUtils::PropertySliderFloat2("SelectableTextAlign", style.SelectableTextAlign, 0.0f, 1.0f, "%.2f", "Alignment applies when a selectable is larger than its text content.");
            ...
            if (ImGui::TreeNodeEx("Safe Area Padding", treeNodeFlags))
            {
                ...
                ImGuiUtils::PropertySliderFloat2("DisplaySafeAreaPadding", style.DisplaySafeAreaPadding, 0.0f, 30.0f, "%.0f");
