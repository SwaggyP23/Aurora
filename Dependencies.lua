...
IncludeDir["msdfAtlasGen"]        = "%{wks.location}/Aurora/dependencies/msdf-atlas-gen/msdf-atlas-gen"
IncludeDir["msdfGen"]             = "%{wks.location}/Aurora/dependencies/msdf-atlas-gen/msdfgen"
